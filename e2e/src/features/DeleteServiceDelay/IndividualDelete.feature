@RegionLevel @DeleteDelayRegionLevelAccess
Feature: Create Functionality Test Cases --- Delay Application

  @Regression @DeleteDelay @RegionLevelAccess @RegionLevel @WithoutRolldownLocations
  Scenario Outline: Creation of Region Level Delay Record without Rolldown Locations.
    ...
    And Click on Submit Button and It should navigate to the Queue page
    And Verify the Created Record in the Queue page with the "<Comments>"
    Then Delete the created record "<Location_Code>" contains the comments "<Comments>"
    ...
    Examples:
      ...
      | 3802362  | 3802362  | INTCU         | Region         | INTCU       | NO                        | Inbound    | WEATHER         | MECHANICAL      |                 | FLIGHT          | 1111       | Pushpa:INTCU:N:12:24:4:35 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | YES                 | YES             | YES         |
