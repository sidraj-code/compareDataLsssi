...
Feature: Edit Delay functionality test cases ----- Delay Application
  ...
  @Regression @EditDelayScenario
    Scenario Outline: Edit the Other Details Section for Service Delay Request With Rolldown locations
    ...
    | 3802362  | 3802362  | INTCU         | Region         | INTCU       | YES                       | YES                            | Inbound    |  WEATHER        |                 |   OTHER         | Flight                   | 1011       | Pushpa:Created:6:52 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 12:32              | 1614        | 0914               | 1814        | 1519               | YES         | NO                 | NO                | YES                      | YES                 | NO                         | NO              | YES                    | YES         | NO                 |