...
Feature: Edit Delay functionality test cases ----- Delay Application
  ...
  @Regression @EditDelayScenario
    Scenario Outline: Edit the Delay Details Section for Service Delay Request With Rolldown locations
    ...
    | 3802362  | 3802362  | INTCU         | Region         | INTCU       | YES                       | YES                            | Inbound    | Outbound          |                 |                 | OTHER           | WEATHER                |                        |                        | FLIGHT          | TRUCK                  | 1011       | 1111              | Pushpa:Created:6:52 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | YES                 | YES             | YES         |