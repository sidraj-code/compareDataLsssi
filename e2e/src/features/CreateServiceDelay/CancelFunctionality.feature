@CancelFunctionality
Feature: Cancel Functionality Of Delay Request

  @Regression @CancelDelay
  Scenario Outline: 591682 - Verification Of Cancel Functionality
    ...
    And Click on Cancel Button It should navigate to the Queue Page with previous requests created
