@CreateDelayDistrictLevelWithoutRolldown
Feature: Create Functionality Of Delay Request For District Level Without Rolldown Locations


  @Regression @CreateDelay @DistrictLevelAccess @SubLocationLevel @WithoutRolldownLocations
  Scenario Outline: 647834 - Verify The Create Functionality Of Delay Request For District Level Without Rolldown Locations --- Selecting 'Sub-Location' as Location Level
    ...
    Examples:
      ...
      | 5175430  | 5175430  | RPEWK         |  Sub Location  | YQMRT       | NO                        | Both       |                 | MECHANICAL      |                 | TRUCK           | 1111       | Pushpa:Sub-Location:YQMRT:N:01:08:2020:05:32 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | YES                 | YES             | YES         |
  ...
  Scenario Outline: 647834 - Verify The Create Functionality Of Delay Request For District Level Without Rolldown Locations --- Selecting 'Location' as Location Level
    ...
    Examples:
     | Username | Password | Location_Code | Location_Level | Location_ID | Include_RollDown_Location | Delay_Type | Cause_Of_Delay1 | Cause_Of_Delay2 | Cause_Of_Delay3 | Flight_Or_Truck | Delay_Time | Comments                                 | Website_Link  | Emp_ID  | Emp_Name      | EST_AA_DELV | EST_AM_DELV | EST_PM_DELV | ETA_on_road | HAL_ODA_available | Same_Day_Reattempts | Courier_Contact | PU_Affected |
     | 5175430  | 5175430  | RPEWK         | Location       | YMXRT       | NO                        | Both       |    WEATHER      |                 |                 | TRUCK           | 1011       | Pushpa:Location:YMXRT:N:01:08:2020:05:19 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | YES                 | YES             | YES         |


  @Regression @CreateDelay @DistrictLevelAccess @RampLevel @WithoutRolldownLocations
  Scenario Outline: 647834 - Verify The Create Functionality Of Delay Request For District Level Without Rolldown Locations --- Selecting 'Ramp' as Location Level
    ...
    Examples:
      | Username | Password | Location_Code | Location_Level | Location_ID | Include_RollDown_Location | Delay_Type | Cause_Of_Delay1 | Cause_Of_Delay2 | Cause_Of_Delay3 | Flight_Or_Truck | Delay_Time | Comments                             | Website_Link  | Emp_ID  | Emp_Name      | EST_AA_DELV | EST_AM_DELV | EST_PM_DELV | ETA_on_road | HAL_ODA_available | Same_Day_Reattempts | Courier_Contact | PU_Affected |
      | 5175430  | 5175430  | RPEWK         | Ramp           | YHZR        | NO                        | Outbound   | WEATHER         | MECHANICAL      |                 | FLIGHT          | 0911       | Pushpa:RAMP:YHZR:N:01:08:2020:05:19 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | YES                 | NO              | YES         |


  @Regression @CreateDelay @DistrictLevelAccess @DistrictLevel @WithoutRolldownLocations
  Scenario Outline: 647834 - Verify The Create Functionality Of Delay Request For District Level Without Rolldown Locations --- Selecting 'District' as Location Level
    ...
    Examples:
      | Username | Password | Location_Code | Location_Level | Location_ID | Include_RollDown_Location | Delay_Type | Cause_Of_Delay1 | Cause_Of_Delay2 | Cause_Of_Delay3 | Flight_Or_Truck | Delay_Time | Comments                             | Website_Link  | Emp_ID  | Emp_Name      | EST_AA_DELV | EST_AM_DELV | EST_PM_DELV | ETA_on_road | HAL_ODA_available | Same_Day_Reattempts | Courier_Contact | PU_Affected |
      | 5175430  | 5175430  | RPEWK         | District       | RPEWK       | NO                        | Both       | WEATHER         |                 | OTHER           | FLIGHT          | 1111       | Pushpa:DIST:RPEWK:N:01:08:2020:05:19 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | NO                  | YES             | YES         |
