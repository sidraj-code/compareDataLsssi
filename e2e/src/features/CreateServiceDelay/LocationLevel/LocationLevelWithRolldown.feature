...
Feature: Create Functionality Of Delay Request For Location Level With Rolldown Locations

  @Regression @CreateDelay @LocationLevelAccess @LocationLevel @WithRolldownLocations
   Scenario Outline: 647834 - Verify The Create Functionality Of Delay Request For Location Level With Rolldown Locations --- Selecting 'Location' as Location Level
    ...
    Examples:
      ...
      | 5080756  | 5080756  | MUVA          | Location       | MUVA        | YES                       | Both       |   WEATHER       |                 |                 | Flight          | 1011       | Pushpa:Location:MAAIP:Y:01:09:2020:12:58 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | NO                  | YES             | YES         |