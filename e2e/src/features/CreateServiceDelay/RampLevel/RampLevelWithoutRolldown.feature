...
Feature: Create Functionality Of Delay Request For Ramp Level Without Rolldown Locations

  @Regression @CreateDelay @RampLevelAccess @SubLocationLevel @WithoutRolldownLocations
  Scenario Outline: 647834 - Verify The Create Functionality Of Delay Request For Ramp Level Without Rolldown Locations --- Selecting 'Sub-Location' as Location Level
    ...
    Examples:
      ...
      | 3810317  | 3810317  | PHLR          | Sub Location   | VEEA       | NO                        | Inbound     |                 | MECHANICAL      |   OTHER        | TRUCK           | 1111       | Pushpa:Sub-Location:VEEA:N:1:9:2020:11:20 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | YES                 | YES             | YES         |



  @Regression @CreateDelay @RampLevelAccess @LocationLevel @WithoutRolldownLocations
  Scenario Outline: 647834 - Verify The Create Functionality Of Delay Request For Ramp Level Without Rolldown Locations --- Selecting 'Location' as Location Level
    ...
    Examples:
      | Username | Password | Location_Code | Location_Level | Location_ID | Include_RollDown_Location | Delay_Type | Cause_Of_Delay1 | Cause_Of_Delay2 | Cause_Of_Delay3 | Flight_Or_Truck | Delay_Time | Comments                          | Website_Link  | Emp_ID  | Emp_Name      | EST_AA_DELV | EST_AM_DELV | EST_PM_DELV | ETA_on_road | HAL_ODA_available | Same_Day_Reattempts | Courier_Contact | PU_Affected |
      | 3810317  | 3810317  | PHLR          |  Location      | ACYA        | NO                        | Both       |   WEATHER       | MECHANICAL      |                 | TRUCK           | 1111       | Pushpa:RAMP:ACYA:N:1:9:2020:11:13 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | YES                 | YES             | NO          |


  @Regression @CreateDelay @RampLevelAccess @RampLevel @WithoutRolldownLocations
  Scenario Outline: 647834 - Verify The Create Functionality Of Delay Request For Ramp Level Without Rolldown Locations --- Selecting 'Ramp' as Location Level
    ...
    Examples:
      | Username | Password | Location_Code | Location_Level | Location_ID | Include_RollDown_Location | Delay_Type | Cause_Of_Delay1 | Cause_Of_Delay2 | Cause_Of_Delay3 | Flight_Or_Truck | Delay_Time | Comments                         | Website_Link  | Emp_ID  | Emp_Name      | EST_AA_DELV | EST_AM_DELV | EST_PM_DELV | ETA_on_road | HAL_ODA_available | Same_Day_Reattempts | Courier_Contact | PU_Affected |
      | 3810317  | 3810317  | PHLR          | Ramp           | PHLR        | NO                        | Inbound    | WEATHER         | MECHANICAL      |                 | TRUCK           | 1111       | Pushpa:RAMP:PHLR:N:1:9:2020:7:13 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | YES                 | YES             | YES         |
