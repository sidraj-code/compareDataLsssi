@RegionLevel @CreateDelayRegionLevelAccess
Feature: Create Functionality Of Delay Request For Sub-Location Level Without Rolldown Locations

  @Regression @CreateDelay @SubLocationLevelAccess @SubLocationLevel @WithoutRolldownLocations
  Scenario Outline: 647834 - Verify The Create Functionality Of Delay Request For Sub Location Level Without Rolldown Locations --- Selecting 'Sub-Location' as Location Level
    ...
    Examples:
      ...
      | 5080756  | 5080756  | MUVA          | Sub Location   | ESPA        | NO                        | Inbound    |   WEATHER       | MECHANICAL      | OTHER           | TRUCK           | 1111       | Pushpa:Sub-Location:ESPA:N:01:09:2020:12:51 | www.fedex.com | 3806310 | Pushpalatha J | 1815        | 1614        | 1514        | 1814        | 1519              | NO                  | YES             | YES         |
